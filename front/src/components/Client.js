...
import {getInitialData, postDateSlected, postTimeSubmit} from "../api";
...
function Client() {
    ...
    const handleSubmit = () => {
        ...
        postTimeSubmit({time,agent,ticketNum,userTimeZone}).then(data=>{
            if(data.msg==='ok'){
                setOpen(false)
                setHidden(true)
                    ...
                    >
                        <Box sx={style}>
                            ...
                            <Typography id="modal-modal-description" color="text.secondary">
                                Note: The office hours may appear uncommon after converting to your local time due to Sophos Home Support is based in North America.
                            </Typography>
                            ...
                            <Typography id="modal-modal-description" style={{color:'red'}} hidden={hidden}>
                                {error}
                            </Typography>
                            <Button style={{marginLeft:"40%"}} variant="contained" onClick={handleSubmit}>Submit</Button>
                        </Box>
                    </Modal>
                </div>
